...
<body>
    ...
    <div class="university-button">
        <button id="goToUniversity" class="btn" onclick="goToUniversity()">08힉생회관 바로가기</button>
    </div>
    <script type="text/javascript">
        (function () {
            ...
            window.goToUniversity = function() {
                window.location.href = 'http://map.kakao.com/link/map/학생회관,36.354495,127.419135';
            }
        })();
    </script>
</body>
