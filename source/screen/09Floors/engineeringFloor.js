const floors = {
  'B1': {
    ...
    rooms: {
      '090001': { x: 7, y: 60, target: ['09B1S1', '09B1S2', '09B1S3'], tmp : [1]},
  ...
  '2F': {
    ...
    rooms: {
      ...
      '090201-B': { x: 28, y: 72,   target: ['092FS1', '092FS2', '092FS3'], tmp : [1]},
      ...
      '090215': { x: 93, y: 11,     target: ['092FS1', '092FS2', '092FS3'], tzp : [2] },
  ...
  '9F': {
    ...
    rooms: {
      '090915': { x: 23, y: 31,     target: ['099FS1', '099FS2', '099FS1'], tmp : [0] },
      '090914': { x: 35, y: 31,     target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090911': { x: 85.5, y: 31,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090910': { x: 89.5, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090909': { x: 80.2, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090908': { x: 70.6, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090907': { x: 62.2, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090906': { x: 53.7, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090905': { x: 43.9, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090904': { x: 35.2, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [1] },
      '090903': { x: 25.6, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [0] },
      '090902': { x: 17.1, y: 62,   target: ['099FS1', '099FS2', '099FS1'], tmp : [0] },
      '090901': { x: 8, y: 62,      target: ['099FS1', '099FS2', '099FS1'], tmp : [0] },
