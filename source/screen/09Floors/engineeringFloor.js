const floors = {
  ...
  '3F': {
    ...
    rooms: {
      ...
      '090305': { x: 6, y: 50, target: ['093FS1'] },
      '090306': { x: 16, y: 50, target: ['093FS1'] },
      '090307': { x: 26, y: 49, target: ['093FS1'] },
      '090308': { x: 33, y: 49, target: ['093FS2'] },
      '090309': { x: 36, y: 49, target: ['093FS2'] },
      '090310': { x: 43, y: 49, target: ['093FS2'] },
      '090311': { x: 51, y: 49, target: ['093FS2'] },
      '090312': { x: 23, y: 29, target: ['093FS1'] },
      '090316': { x: 48, y: 31, target: ['093FS2'] },
      '090317': { x: 70, y: 31, target: ['093FS2'] },
      '090317-A': { x: 63, y: 31, target: ['093FS3'] },
      '090317-B': { x: 60, y: 31, target: ['093FS3'] },
      '090318': { x: 76, y: 31, target: ['093FS3'] },
      '090319': { x: 80, y: 31, target: ['093FS3'] },
      '090320': { x: 90, y: 31, target: ['093FS3'] },
  ...
  '4F': {
    ...
    rooms: {
      ...
      '090408': { x: 26, y: 50, target: ['094FS1'] },
      '090409': { x: 36, y: 50, target: ['094FS2'] },
      '090410': { x: 46, y: 50, target: ['094FS2'] },
  ...
  '5F': {
    ...
    rooms: {
      ...
      '090504': { x: 2, y: 53, target: ['095FS1'] },
      '090505': { x: 6.5, y: 53, target: ['095FS1'] },
      '090506': { x: 11.5, y: 53, target: ['095FS1'] },
      '090507': { x: 15.5, y: 53, target: ['095FS1'] },
  ...
  '6F': {
    ...
    rooms: {
      ...
      '090604': { x: 9, y: 39, target: ['096FS1'] },
      '090605': { x: 17.5, y: 39, target: ['096FS1'] },
      '090606': { x: 24, y: 39, target: ['096FS1'] },
      '090607': { x: 49, y: 39, target: ['096FS1'] },
      '090608': { x: 58, y: 39, target: ['096FS2'] },
      '090609': { x: 63, y: 39, target: ['096FS2'] },
      '090610': { x: 70, y: 39, target: ['096FS2'] },
      '090611': { x: 75, y: 39, target: ['096FS2'] },
      '090612': { x: 81, y: 39, target: ['096FS2'] },
      '090613': { x: 86, y: 39, target: ['096FS2'] },
      '090614': { x: 91, y: 39, target: ['096FS2'] },
