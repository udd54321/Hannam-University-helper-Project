...
<body>
    ...
    <div class="university-button">
        <button id="goToUniversity" class="btn" onclick="goToUniversity()">09공과대학 바로가기</button>
    </div>
    <script type="text/javascript">
        (function () {
            ...
            window.goToUniversity = function() {
                window.location.href = 'http://map.kakao.com/link/map/공과대학,36.3562174,127.4195159';
            }
        })();
    </script>
</body>
