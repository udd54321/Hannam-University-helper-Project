...
const FirstFloorScreen = () => {
  ...
  const [currentImage] = useState(floors['03_1F'].image);
  ...
  const setStartPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '03_1F', goalFloor: '03_1F' }); // startFloor와 goalFloor 전달
  };

  const setArrivalPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '03_1F', goalFloor: '03_1F' });
  };
const excludedRooms = ['031FS1', '031FS2'];
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            ...
            {Object.keys(floors['03_1F'].rooms)
                           .filter((roomId) => !excludedRooms.includes(roomId)) // 제외할 방 필터링
                           .map((roomId) => {
              const room = floors['03_1F'].rooms[roomId];
              const isRotated = [
                '030101',
                '030102',
                '030103',
