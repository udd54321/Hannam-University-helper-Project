...
const FirstFloorScreen = () => {
  ...
  const [currentImage] = useState(floors['04_1F'].image);
  ...
  const setStartPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '04_1F', goalFloor: '04_1F' }); // startFloor와 goalFloor 전달
  };

  const setArrivalPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '04_1F', goalFloor: '04_1F' });
  };
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            ...
            {Object.keys(floors['04_1F'].rooms).map((roomId) => {
              const room = floors['04_1F'].rooms[roomId];
              const isRotated = [
                '040101',
                '040102',
                '040103',
