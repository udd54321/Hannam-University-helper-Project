...
<body>
    ...
    <div class="university-button">
        <button id="goToUniversity" class="btn" onclick="goToUniversity()">03사범대학 바로가기</button>
    </div>
    <script type="text/javascript">
        (function () {
            ...
            window.goToUniversity = function() {
                window.location.href = 'http://map.kakao.com/link/map/사범대,36.3545232,127.4202659';
            }
        })();
    </script>
</body>
