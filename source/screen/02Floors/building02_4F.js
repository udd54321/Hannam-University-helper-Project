...
const FourthFloorScreen = () => {
  ...
  const [currentImage] = useState(floors['02_4F'].image);
  ...
  const setStartPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '02_4F', goalFloor: '02_4F' }); // startFloor와 goalFloor 전달
  };

  const setArrivalPointer = (room) => {
    navigation.navigate('Gil', { roomId: room, startFloor: '02_4F', goalFloor: '02_4F' });
  };
const excludedRooms = ['024FS1', '024FS2'];
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            ...
            {Object.keys(floors['02_4F'].rooms)
                           .filter((roomId) => !excludedRooms.includes(roomId)) // 제외할 방 필터링
                           .map((roomId) => {
              const room = floors['02_4F'].rooms[roomId];
              const isRotated = [
                '020401',
                '020402',
                '020403',
