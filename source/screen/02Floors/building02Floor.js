const building02Floor = {
    '02_1F': {
      ...
      rooms: {
        ...
        '020101-A': { x: 1, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020102': { x: 16, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020103': { x: 23, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020104': { x: 31, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020105': { x: 36, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020106': { x: 56, y: 50 , target: ['021FS1','021FS2'],tmp:[0]},
        '020108': { x: 69, y: 50 , target: ['021FS1','021FS2'],tmp:[1]},
        '020109': { x: 84, y: 50 , target: ['021FS1','021FS2'],tmp:[1]},
        '020113': { x: 28, y: 31 , target: ['021FS1','021FS2'],tmp:[0]},
        '020110': { x: 57, y: 31.2 , target: ['021FS1','021FS2'],tmp:[0]},
    ...
    '02_2F': {
      ...
      rooms: {
       // '020201': { x: 4, y: 30.5 },
        '020202': { x: 2.5, y: 49,target: ['022FS1','022FS2'],tmp:[0] },
        '020203': { x: 14, y: 49 ,target: ['022FS1','022FS2'],tmp:[0]},
        '020204': { x: 23, y: 49 ,target: ['022FS1','022FS2'],tmp:[0]},
        '020205': { x: 33, y: 49 ,target: ['022FS1','022FS2'],tmp:[0]},
        '020208': { x: 42, y: 49 ,target: ['022FS1','022FS2'],tmp:[0]},
        '020209': { x: 49, y: 49 ,target: ['022FS1','022FS2'],tmp:[0]}, 
        '020210': { x: 57, y: 49 ,target: ['022FS1','022FS2'],tmp:[1]},
        '020211': { x: 68, y: 49 ,target: ['022FS1','022FS2'],tmp:[1]},
        '020212': { x: 82, y: 49 ,target: ['022FS1','022FS2'],tmp:[1]},
    ...
    '02_3F': {
      ...
      rooms: {
        ...
        '020302': { x: 13, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020303': { x: 17, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020304': { x: 22, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020305': { x: 26, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020306': { x: 31, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020307': { x: 36, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020308': { x: 40, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020309': { x: 45, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]}, 
        '020310': { x: 50, y: 49 ,target: ['023FS1', '023FS2'],tmp:[0]},
        '020311': { x: 57, y: 49 ,target: ['023FS1', '023FS2'],tmp:[1]},
        '020312': { x: 72, y: 49 ,target: ['023FS1', '023FS2'],tmp:[1]},
        '020313': { x: 87, y: 49 ,target: ['023FS1', '023FS2'],tmp:[1]},
