...
<body>
    ...
    <div class="university-button">
        <button id="goToUniversity" class="btn" onclick="goToUniversity()">11인사례교양동 바로가기</button>
    </div>
    <script type="text/javascript">
        (function () {
            ...
            window.goToUniversity = function() {
                window.location.href = 'http://map.kakao.com/link/map/인사례교양동,36.3546899,127.4224046';
            }
        })();
    </script>
</body>
