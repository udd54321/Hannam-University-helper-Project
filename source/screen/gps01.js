...
<body>
    ...
    <div class="university-button">
        <button id="goToUniversity" class="btn" onclick="goToUniversity()">01인돈기념관 바로가기</button>
    </div>
    <script type="text/javascript">
        (function () {
            ...
            window.goToUniversity = function() {
                window.location.href = 'http://map.kakao.com/link/map/인돈기념관,36.3554675,127.4208214';
            }
        })();
    </script>
</body>
