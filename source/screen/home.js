...
import { View, Text, Image, ScrollView, StyleSheet, TouchableOpacity, Button, Dimensions } from 'react-native';
...
const Home = ({ navigation }) => {
  ...
  const pressTestScreen = () => navigation.navigate('TestScreen');
