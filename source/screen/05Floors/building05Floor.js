const building05Floor = {
    '05_1F': {
      ...
      rooms: {
        ...
        '050106': { x: 37, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[1]},
        '050107': { x: 43, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[1]},
        '050108': { x: 49, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[2]},
        '050109': { x: 54, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[2]},
        '050110': { x: 61, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[2]},
        '050111': { x: 68, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[2]},
        '050112': { x: 85, y: 45 , target: ['021FS1','051FS2', '051FS3'],tmp:[2]},
      ...
      hallway: [
           ...
           { x: 30, y: 15, connections: [4,6], rooms: ['051FS2'], },
           { x: 30, y: 22, connections: [5, 7], rooms: [], },
           { x: 30, y: 28, connections: [6, 8], rooms: [], },
           { x: 30, y: 34, connections: [7,9,10], rooms: [], },
           { x:30, y: 50, connections: [8], rooms: [], },//9
           { x: 36, y: 34, connections: [9,11], rooms: ['050106'], },//10
           { x: 42, y: 34, connections: [10,12], rooms: ['050107'], },
           { x: 49, y: 34, connections: [11,13], rooms: ['050108'], },
           { x: 55, y: 34, connections: [12,14], rooms: ['050109'], },
           { x: 62, y: 34, connections: [13,15], rooms: ['050110'], },
           { x: 69, y: 34, connections: [14,16], rooms: ['050111'], },
           { x: 73, y: 34, connections: [15,17], rooms: ['051FS3'], },//16
    ...
    '05_2F': {
      ...
      hallway: [
           { x: 8, y: 38, connections: [1], rooms: ['050101','052FS1']},//0
           { x: 18, y: 38, connections: [0, 2], rooms: ['050202']},
           { x: 25, y: 38, connections: [1,3], rooms: ['050202-A']},
           { x: 25, y: 38, connections: [2,4], rooms: ['052FS2']},//3
           ...
           { x: 60, y: 62, connections: [9,11,20], rooms: ['050205']},//
           { x: 64, y: 62, connections: [10,12], rooms: ['050206']},//11
           { x: 69, y: 62, connections: [11,13], rooms: ['050206-A']},
           { x: 72, y: 62, connections: [12,14], rooms: ['052FS3']},//13
           ...
           { x: 91, y: 62, connections: [17,19], rooms: ['050211','050216']},
           { x: 96, y: 62, connections: [18], rooms: ['050212','050217']},//19
           { x: 60, y: 44, connections: [10,21], rooms: ['050223']},
           { x: 60, y: 34, connections: [20,22], rooms: ['050222','052019','050220']},
    ...
    '05_3F': {
      ...
      hallway: [
        ...
        { x: 53, y: 18, connections: [27,29], rooms: ['050331',]},
        { x: 49, y: 12, connections: [28,30], rooms: ['050342']},
        { x: 45, y: 12, connections: [29,31], rooms: ['050343']},
        { x: 41, y: 18, connections: [30,32], rooms: ['050344',]},
    ...
    '05_4F': {
      ...
      hallway: [
           ...
           { x: 56, y: 60, connections: [11,13], rooms: ['050413']},//12
           ...
           { x: 87, y: 73, connections: [1921], rooms: ['050420','050424']},
           ...
           { x: 56, y: 18, connections: [26,28], rooms: ['050418','050426']},
